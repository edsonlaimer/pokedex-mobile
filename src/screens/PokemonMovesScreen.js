...
const styles = StyleSheet.create({
  ...
  backText:  { color: '#FFFFFF', fontSize: 15, fontWeight: '600', marginBottom: 18 },
  heroTitle: { fontSize: 28, fontWeight: '800', color: '#FFFFFF', textTransform: 'capitalize', marginBottom: 10 },
